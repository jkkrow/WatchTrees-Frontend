...
const PrivatePolicy: React.FC = () => {
  return (
    <Document>
      ...
      <p>
        WatchTree (“we,” “our,” or “us”) is committed to protecting your
        privacy. This Privacy Policy explains how your personal information is
        collected, used, and disclosed by WatchTree.
      </p>
      <p>
        ...
        WatchTree. By accessing or using our Service, you signify that you have
      ...
      <ul>
        ...
        <li>
          ...
          based, in this case is South Korea
        </li>
        <li>
          Customer: refers to the company, organization or person that signs up
          to use the WatchTree Service to manage the relationships with your
        ...
        <li>
          Personnel: refers to those individuals who are employed by WatchTree
      ...
      <h2>When does WatchTree use end user information from third parties?</h2>
      <p>
        WatchTree will collect End User Data necessary to provide the WatchTree
      ...
      <h2>When does WatchTree use customer information from third parties?</h2>
      <p>
        ...
        in becoming a WatchTree customer, we receive information from a third
        party that provides automated fraud detection services to WatchTree. We
      ...
      <p>
        WatchTree will collect personal information that you submit to us. We
      ...
      <p>
        We keep your information only so long as we need it to provide WatchTree
      ...
      <p>
        ...
        any information you transmit to WatchTree or guarantee that your
      ...
      <p>
        WatchTree is incorporated in South Korea. Information collected via our
      ...
      <h2>
        Is the information collected through the WatchTree Service secure?
      </h2>
      <p>
      ...
      <p>
        ...
        WatchTree collects depend on your relationship with WatchTree. Personnel
      ...
      <p>
        ...
        the assets of WatchTree or any of its Corporate Affiliates (as defined
        herein), or that portion of WatchTree or any of its Corporate Affiliates
      ...
      <p>
        ...
        WatchTree, whether by ownership or otherwise. Any information relating
      ...
      <h2>Governing Law</h2>
      <p>
        This Privacy Policy is governed by the laws of South Korea without
      ...
      <p>
        The laws of South Korea, excluding its conflicts of law rules, shall
      ...
      <p>
        By using WatchTree or contacting us directly, you signify your
      ...
      <p>
        ...
        party sites. WatchTree does not make any representation as to the
      ...
      <p>
        Advertising keeps WatchTree and many of the websites and services you
      ...
      <p>
        ...
        WatchTree of the third party sites, goods or services. WatchTree takes
      ...
      <p>
        ...
        At WatchTree we strongly believe that your data privacy is very
      ...
      <p>
        ...
        requirements of GDPR. WatchTree processes or stores all personal data in
