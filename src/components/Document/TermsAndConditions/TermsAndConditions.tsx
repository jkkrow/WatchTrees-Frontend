...
const TermsAndConditions: React.FC = () => {
  return (
    <Document>
      ...
      <p>Updated at 2022-09-06</p>

      <hr />

      <h2>General Terms</h2>
      <p>
        By accessing and placing an order with WatchTree, you confirm that you
      ...
      <p>
        Under no circumstances shall WatchTree team be liable for any direct,
        ...
        inability to use, the materials on this site, even if WatchTree team or
      ...
      <p>
        WatchTree will not be responsible for any outcome that may occur during
      ...
      <h2>License</h2>
      <p>
        WatchTree grants you a revocable, non-exclusive, non-transferable,
        limited license to download, install and use the website strictly in
        accordance with the terms of this Agreement.
      </p>
      <p>
        These Terms & Conditions are a contract between you and WatchTree
        (referred to in these Terms & Conditions as "WatchTree", "us", "we" or
        "our"), the provider of the WatchTree website and the services
        accessible from the WatchTree website (which are collectively referred
        to in these Terms & Conditions as the "WatchTree Service").
      </p>
      <p>
        You are agreeing to be bound by these Terms & Conditions. If you do not
        agree to these Terms & Conditions, please do not use the WatchTree
      ...
      <ul>
        ...
        <li>
          ...
          refers to WatchTree, that is responsible for your information under
          this Terms & Conditions.
        </li>
        <li>
          Country: where WatchTree or the owners/founders of WatchTree are
          based, in this case is KR
        </li>
        <li>
          Device: any internet connected device such as a phone, tablet,
          computer or any other device that can be used to visit WatchTree and
          use the services.
        </li>
        <li>
          Service: refers to the service provided by WatchTree as described in
        ...
        <li>
          Website: WatchTree's site, which can be accessed via this URL:
          www.watchtree.net
        </li>
        <li>
          You: a person or entity that is registered with WatchTree to use the
          Services.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          of copyright or trademark) of WatchTree or its affiliates, partners,
          suppliers or the licensors of the website.
        </li>
      </ul>
      <h2>Return and Refund Policy</h2>
      <p>
        Thanks for shopping at WatchTree. We appreciate the fact that you like
      ...
      <p>
        ...
        apply to transactions at WatchTree. We’ll be as brief as our attorneys
        will allow. The main thing to remember is that by placing an order or
        making a purchase at WatchTree, you agree to the terms along with
        WatchTree's Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        (collectively, "Suggestions") provided by you to WatchTree with respect
        to the website shall remain the sole and exclusive property of
        WatchTree.
      </p>
      <p>
        WatchTree shall be free to use, copy, modify, publish, or redistribute
      ...
      <p>
        ...
        contain links to other websites not operated or controlled by WatchTree.
      ...
      <h2>Cookies</h2>
      <p>
        WatchTree uses "Cookies" to identify the areas of our website that you
      ...
      <p>
        You acknowledge and agree that WatchTree may stop (permanently or
        temporarily) providing the Service (or any features within the Service)
        to you or to users generally at WatchTree’s sole discretion, without
        prior notice to you. You may stop using the Service at any time. You do
        not need to specifically inform WatchTree when you stop using the
        Service. You acknowledge and agree that if WatchTree disables access to
      ...
      <p>
        WatchTree reserves the right to modify, suspend or discontinue,
      ...
      <p>
        WatchTree may from time to time provide enhancements or improvements to
      ...
      <p>
        ...
        the website. You agree that WatchTree has no obligation to (i) provide
      ...
      <p>
        You acknowledge and agree that WatchTree shall not be responsible for
        ...
        or any other aspect thereof. WatchTree does not assume and shall not
      ...
      <p>
        WatchTree may, in its sole discretion, at any time and for any or no
      ...
      <p>
        ...
        WatchTree, in the event that you fail to comply with any provision of
      ...
      <p>
        Termination of this Agreement will not limit any of WatchTree's rights
      ...
      <p>
        You agree to indemnify and hold WatchTree and its parents, subsidiaries,
      ...
      <p>
        ...
        permitted under applicable law, WatchTree, on its own behalf and on
        ...
        Without limitation to the foregoing, WatchTree provides no warranty or
      ...
      <p>
        Without limiting the foregoing, neither WatchTree nor any WatchTree's
        ...
        content, or e-mails sent from or on behalf of WatchTree are free of
      ...
      <p>
        ...
        of WatchTree and any of its suppliers under any provision of this
      ...
      <p>
        ...
        WatchTree or its suppliers be liable for any special, incidental,
        ...
        this Agreement), even if WatchTree or any supplier has been advised of
      ...
      <p>
        ...
        notices published by WatchTree on the Services, shall constitute the
        entire agreement between you and WatchTree concerning the Services. If
        ...
        any other term, and WatchTree's failure to assert any right or provision
        under this Agreement shall not constitute a waiver of such right or
        provision. YOU AND WatchTree AGREE THAT ANY CAUSE OF ACTION ARISING OUT
      ...
      <p>
        WatchTree reserves the right, at its sole discretion, to modify or
      ...
      <p>
        ...
        agree to the new terms, you are no longer authorized to use WatchTree.
      </p>

      <h2>Entire Agreement</h2>
      <p>
        The Agreement constitutes the entire agreement between you and WatchTree
        regarding your use of the website and supersedes all prior and
        contemporaneous written or oral agreements between you and WatchTree.
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other WatchTree's services, which WatchTree will
      ...
      <p>
        ...
        thereof), are owned by WatchTree, its licensors or other providers of
        such material and are protected by KR and international copyright,
        ...
        without the express prior written permission of WatchTree, unless and
      ...
      <p>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR WatchTree's INTELLECTUAL PROPERTY
        RIGHTS. The term “dispute” means any dispute, action, or other
        controversy between you and WatchTree concerning the Services or this
      ...
      <p>
        In the event of a dispute, you or WatchTree must give the other a Notice
        ...
        <a href="mailto: support@watchtree.net">support@watchtree.net</a>{' '}
        WatchTree will send any Notice of Dispute to you by mail to your address
        if we have it, or otherwise to your email address. You and WatchTree
        ...
        (60) days, you or WatchTree may commence arbitration.
      </p>

      <h2>Binding Arbitration</h2>
      <p>
        If you and WatchTree don’t resolve any dispute by informal negotiation,
      ...
      <p>
        ...
        and will become the sole property of WatchTree without any compensation
        or credit to you whatsoever. WatchTree and its affiliates shall have no
      ...
      <h2>Promotions</h2>
      <p>
        WatchTree may, from time to time, include contests, promotions,
      ...
      <p>
        ...
        of WatchTree. WatchTree will be entitled to injunctive or other
        equitable relief (without the obligations of posting any bond or surety)
        in the event of any breach or anticipatory breach by you. WatchTree
        operates and controls the WatchTree Service from its offices in KR. The
        ...
        choose to access the WatchTree Service from other locations do so on
        ...
        & Conditions (which include and incorporate the WatchTree Privacy
        Policy) contains the entire understanding, and supersedes all prior
        understandings, between you and WatchTree concerning its subject matter,
      ...
      <h2>Disclaimer</h2>
      <p>
        WatchTree is not responsible for any content, code or any other
        imprecision.
      </p>
      <p>WatchTree does not provide warranties or guarantees.</p>
      <p>
        In no event shall WatchTree be liable for any special, direct, indirect,
      ...
      <p>
        The WatchTree Service and its contents are provided "as is" and "as
        available" without any warranty or representations of any kind, whether
        express or implied. WatchTree is a distributor and not a publisher of
        the content supplied by third parties; as such, WatchTree exercises no
        ...
        accessible via the WatchTree Service. Without limiting the foregoing,
        WatchTree specifically disclaims all warranties and representations in
        any content transmitted on or in connection with the WatchTree Service
        or on sites that may appear as links on the WatchTree Service, or in the
        products provided as a part of, or otherwise in connection with, the
        WatchTree Service, including without limitation any warranties of
        merchantability, fitness for a particular purpose or non-infringement of
        third party rights. No oral advice or written information given by
        WatchTree or any of its affiliates, employees, officers, directors,
        ...
        foregoing, WatchTree does not warrant that the WatchTree Service will be
